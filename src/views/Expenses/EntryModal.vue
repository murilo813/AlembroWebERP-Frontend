            ...
            <div class="modal-content">
                ...
                <header class="modal-header">
                    <div class="modal-header-info">
                        <h2 class="modal-title">Detalhes da Entrada <span class="emerald">#{{ formattedData.entryId
                                }}</span></h2>
                        <div class="subtitle-row">
                            <p class="modal-subtitle" style="color: #f8fafc;">
                                Fornecedor: <span class="emerald">{{ formattedData.provider }}</span>
                            </p>
                ...
                <div class="modal-body modal-details-body">
                    ...
                    <div class="details-section">
                        <div class="details-grid">
                            <div class="detail-box">
                                ...
                                <span class="detail-value"><i class="fa-regular fa-user"
                                        style="color: #64748b; margin-right: 0.5rem;"></i> {{ formattedData.linkedBy
                                    }}</span>
                            </div>
                            <div class="detail-box">
                                <span class="detail-label">Data do Vínculo</span>
                                <span class="detail-value"><i class="fa-regular fa-calendar"
                                        style="color: #64748b; margin-right: 0.5rem;"></i> {{ formattedData.linkedDate
                                    }}</span>
                            </div>
                            <div class="detail-box obs-box" style="grid-column: span 2;">
                                <span class="detail-label">Observações de Vínculo</span>
                                <span class="detail-value text-muted" v-if="!formattedData.observation">Nenhuma
                                    observação registrada.</span>
                    ...
                    <div class="details-section">
                        ...
                        <div class="financial-summary-grid">
                            ...
                            <div class="fin-item">
                                <span class="fin-label">Descontos (-)</span>
                                <span class="fin-value">{{ formattedData.totals.discount }}</span>
                            </div>
                            <div class="fin-item">
                            ...
                            <table class="alembro-table small-text">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 14rem;">Custo Unit.</th>
                                        <th class="text-center" style="width: 12rem;">Acrés. (+)</th>
                                        <th class="text-center" style="width: 12rem;">Desc. (-)</th>
                                        <th class="text-right" style="width: 16rem;">Valor Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="item in formattedData.items" :key="item.id">
                                        ...
                                        <td class="text-center">{{ item.formattedUnitCost }}</td>
                                        <td class="text-center">{{ item.formattedAddition }}</td>
                                    ...
                                    <tr v-if="!formattedData.items || formattedData.items.length === 0">
                                        <td colspan="8" class="text-center empty-data" style="padding: 3rem;">Nenhum
                                            item registrado para esta nota.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <footer class="modal-footer modal-footer-compact">
                    <div class="modal-footer-total">
                        <span class="label">Total da Nota:</span>
                        <span class="value">{{ formattedData.totals.grandTotal }}</span>
                    </div>
